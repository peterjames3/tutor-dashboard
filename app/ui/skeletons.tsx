...
export function CardSkeleton() {
  return (
    <div className="bg-gray-200 rounded-lg shadow p-12 animate-pulse">
      <div className="flex justify-between items-center">
        <div>
          <div className="h-5 bg-gray-300 rounded w-28"></div>
          <div className="h-9 bg-gray-300 rounded w-1/2 mt-4"></div>
        </div>
        <div className="p-3 rounded-full bg-gray-300 w-14 h-14"></div>
      </div>
    </div>
  );
}
...
export function EndToEndExamSupportSkeleton() {
  return (
    <div
      className={`${shimmer} mt-12 relative flex w-full flex-col overflow-hidden md:col-span-4`}
    >
      <div className="flex flex-col gap-2">
        <div className="title"> End-to-End Exam Support</div>
